...
def crop_picture(img_rd,size):
    ...
    if len(faces)==0:
        ...
        faces.append(dlib.rectangle(1,1,320,320))

    # img_rd=cv2.imread("/home/data/CZP/2024megc_test/test_crop/CAS_data/dzw_f3/0009.jpg")
...
def proce2(flow1_total,yuzhi1,yuzhi2,position,xuhao,k,a,totalflow,totalflow_mic,totalflow_mac):
    ...
    flow1_total_fenxi = adjust_intervals(flow1_total_fenxi, flow1_total_edm1, gradient_threshold=0.25)
